...
const RoomDetail = () => {
  ...
  return (
    <Box component="main" sx={{ bgcolor: "#f8f7f3" }}>
    <Container maxWidth="lg" sx={{ pt: { xs: 3, md: 5 }, pb: { xs: 8, md: 12 } }}>
      ...
      <Box component="section" aria-label="Đánh giá của khách">
        {loadingReviewBlock ? (
          ...
          <Box sx={{ py: 4.5, borderTop: "1px solid #dedbd4" }}><Typography component="h2" variant="h2" sx={{ fontSize: { xs: 28, md: 32 } }}>Đánh giá của khách</Typography><Typography color="text.secondary" sx={{ mt: 1 }}>Chưa có đánh giá cho hạng phòng này.</Typography></Box>
        ) : (
          <>
