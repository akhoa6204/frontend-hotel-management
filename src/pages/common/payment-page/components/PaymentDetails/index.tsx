...
const PaymentDetails = ({ finalTotal, depositAmount, remainingBalance, loading, onPayment }: Props) => (
  <Box component="section" aria-labelledby="payment-today-title">
    ...
    <Typography
      ...
      component="h2"
      sx={{ mt: 1, fontSize: { xs: 36, sm: 42, md: 48 }, lineHeight: 1.1, fontWeight: 750, color: "#183746" }}
    >
      {fmtVND(depositAmount)} VND
    </Typography>
    <Stack direction="row" spacing={1} alignItems="center" sx={{ mt: 1.5, color: "#425866" }}>
    ...
    <Typography component="h3" sx={{ fontSize: { xs: 22, md: 25 }, fontWeight: 700, color: "#183746" }}>
      Tóm tắt thanh toán
    </Typography>
    <Stack spacing={1.75} sx={{ mt: 2.5, maxWidth: 620 }}>
      ...
      <Stack direction="row" justifyContent="space-between" spacing={2}>
        ...
        <Typography fontWeight={700} color="#183746">{fmtVND(depositAmount)} VND</Typography>
      </Stack>
      <Stack direction="row" justifyContent="space-between" spacing={2}>
    ...
    <Box component="section" aria-labelledby="deposit-policy-title">
      <Stack direction="row" spacing={1.25} alignItems="center">
        ...
        <Typography id="deposit-policy-title" component="h3" sx={{ fontSize: { xs: 22, md: 25 }, fontWeight: 700, color: "#183746" }}>
          Điều kiện tiền cọc
        </Typography>
      </Stack>
      ...
      <Box component="ul" sx={{ m: 0, mt: 2, pl: 2.5, color: "#425866", "& li": { pl: 0.75, mb: 1 } }}>
