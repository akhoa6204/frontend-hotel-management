const en = {
  ...
  schedules: {
    ...
    import: {
      action: "Import Excel",
      title: "Import staff schedules",
      subtitle: "Upload, review, and correct assignments before saving them.",
      close: "Close import",
      chooseFile: "Choose Excel file",
      replaceFile: "Replace file",
      empty: "Upload an Excel workbook to preview staff schedules.",
      formatHint: "Required columns: Email, Work Date, Shift Code. Supported file: .xlsx.",
      unknownShift: "Unknown shift",
      search: "Search employee name or email…",
      filteredCount: "{{count}} matching rows",
      reviewErrors: "Review {{count}} errors",
      removeRow: "Remove row from preview",
      removeRowLabel: "Remove preview row {{row}}",
      cancel: "Cancel",
      ...
      status: { VALID: "Valid", INVALID: "Invalid", EDITED: "Edited" },
      validation: {
        EMPLOYEE_NOT_FOUND: "Employee email was not found",
        EMPLOYEE_INELIGIBLE: "Employee cannot receive schedules",
        SHIFT_NOT_FOUND: "Shift code was not found",
        INVALID_DATE: "Work date is invalid",
        DUPLICATE_ASSIGNMENT: "Duplicate assignment",
        OVERLAPPING_SHIFT: "Shift overlaps another assignment",
      },
      errors: {
        preview: "Unable to preview the Excel file.",
        revalidate: "Unable to revalidate the edited rows.",
        confirm: "Unable to import staff schedules.",
      },
    },
    ...
    notifications: {
      ...
      importSuccess: "Imported {{count}} staff schedules successfully",
    },
  },
