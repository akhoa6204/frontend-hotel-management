const vi = {
  ...
  schedules: {
    ...
    import: {
      action: "Nhập Excel",
      title: "Nhập lịch làm nhân viên",
      subtitle: "Tải lên, kiểm tra và sửa dữ liệu trước khi lưu.",
      close: "Đóng nhập lịch",
      chooseFile: "Chọn tệp Excel",
      replaceFile: "Đổi tệp",
      empty: "Tải tệp Excel lên để xem trước lịch làm.",
      formatHint: "Các cột bắt buộc: Email, Work Date, Shift Code. Định dạng: .xlsx.",
      unknownShift: "Ca làm không xác định",
      search: "Tìm theo tên hoặc email nhân viên…",
      filteredCount: "{{count}} dòng phù hợp",
      reviewErrors: "Xem {{count}} lỗi",
      removeRow: "Xóa dòng khỏi bản xem trước",
      removeRowLabel: "Xóa dòng xem trước {{row}}",
      cancel: "Hủy",
      revalidate: "Kiểm tra lại",
      revalidateAll: "Kiểm tra lại tất cả",
      confirm: "Xác nhận nhập",
      confirming: "Đang nhập…",
      summary: {
        total: "{{count}} dòng",
        valid: "{{count}} hợp lệ",
        invalid: "{{count}} không hợp lệ",
      },
      columns: {
        row: "Dòng",
        employee: "Nhân viên",
      ...
      status: { VALID: "Hợp lệ", INVALID: "Không hợp lệ", EDITED: "Đã sửa" },
      validation: {
        EMPLOYEE_NOT_FOUND: "Không tìm thấy email nhân viên",
        EMPLOYEE_INELIGIBLE: "Nhân viên không thể được phân ca",
        SHIFT_NOT_FOUND: "Không tìm thấy mã ca",
        INVALID_DATE: "Ngày làm không hợp lệ",
        DUPLICATE_ASSIGNMENT: "Lịch làm bị trùng",
        OVERLAPPING_SHIFT: "Ca làm bị chồng giờ",
      },
      errors: {
        preview: "Không thể xem trước tệp Excel.",
        revalidate: "Không thể kiểm tra lại dữ liệu đã sửa.",
        confirm: "Không thể nhập lịch làm.",
      },
    },
    ...
    notifications: {
      ...
      importSuccess: "Đã nhập thành công {{count}} lịch làm",
    },
  },
